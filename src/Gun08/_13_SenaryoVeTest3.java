...
public class _13_SenaryoVeTest3 extends BaseDriver {
    @Test
    public void Test3(){
//        Test Senaryosu
...
//        öncesinde de görünmediğini assert ile doğrulayınız.
        ...
        /*// 1.YONTEM
        // hidden_eleman'ın görünmediğinin kontrol edileceği yer
        List<WebElement> secondEmail=driver.findElements(By.cssSelector("[id='reg_form_box']>[class='hidden_elem']"));
        Assert.assertTrue("2.email şu an gözüküyor mu",(secondEmail.size()==1));    // hidden eleman şu an varsa size=1,yoksa size=0
        ...
        // hidden_eleman'ın göründüğünün kontrol edileceği yer
        secondEmail=driver.findElements(By.cssSelector("[id='reg_form_box']>[class='hidden_elem']"));
        Assert.assertTrue("2.email şu an gözüküyor mu",(secondEmail.size()==0));    // // hidden eleman şu an varsa size=1,yoksa size=0*/
